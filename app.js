(function () {
  ...
  var MOCK_ITEMS = [
    ...
    { id: 'mock4', name: 'USB-C 扩展坞', category: '数码', status: '已完成', price: 189, qty: 1, date: '2026-06-15', shop: '京东', note: '7合1', images: ['https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=400&fit=crop&q=80', 'https://images.unsplash.com/photo-1625842268584-8f3296236761?w=600&h=400&fit=crop&q=80'], createdAt: Date.now() - 3000 },
    { id: 'mock5', name: '台灯', category: '家具', status: '待发货', price: 79, qty: 1, date: '2026-06-14', shop: '', note: '护眼款', images: ['https://images.unsplash.com/photo-1507473885765-e6ed057ab6fe?w=600&h=400&fit=crop&q=80', 'https://images.unsplash.com/photo-1513506003901-1e6a229e2d15?w=600&h=400&fit=crop&q=80'], createdAt: Date.now() - 4000 }
  ];
